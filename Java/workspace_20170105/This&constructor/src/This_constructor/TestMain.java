...
class Student
{
	...
	//생성자
	//디폴트 생성자(default) : 기본
	public Student()//생성자 함수앞에 public이나private말고 못붙임
	{
		name = "홍길동";
		kor=0;
		eng=0;
	...
	public Student(String n, int k, int e, int m)
	{
		...
		eng=e;
		mat=m;
		System.out.println("매개변수 세개짜리 호출하기");
	}
...
public class TestMain {
	...
	public static void main(String[] args) {
		 ...
		 * 2. 변수의 초기화나, 자원배분등의 준비 작없을 위한 메서드이다.
		 * 3. 생성자는 반환형을 쓸 수 없다. 메서드 이름앞에 접근 제한자 
		 *    말고는 아무것도 못 붙인다. int 나 void 이런거 못붙임
		 * 4. public 접근 제한으로 해야 객체가 생성된다.
		 * 5. 매개변수를 줄 수 있어서 동일한 이름으로 여러개 만들 수 있다
		 * 6. 시스템이 호출되기 때문에 이름을 마음대로 못붙인다.
		 *    이름은 언제나 클래스명과 동일해야한다.   
		 * 
		 */
		//객체 생성하기
